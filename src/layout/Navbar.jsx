  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white">
      ...
      <ul className="hidden md:flex space-x-8 text-gray-700 font-medium">
        <li><a href="./HomePage" className="hover:text-black">Home</a></li>
        <li><a href="./Contact" className="hover:text-black">Contact</a></li>
        <li><a href="./About" className="hover:text-black">About</a></li>
        <li><a href="./SignUp" className="hover:text-black">Sign Up</a></li>
      </ul>
      ...
      <div className="flex items-center space-x-4">
        ...
        <a href="./cart" className="text-gray-700 hover:text-black">
          <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
            <path
              d="M9 2L7.17 6M9 2L10.83 6M9 2H15M15 2L16.83 6M15 2L13.17 6M7.17 6H16.83M7.17 6L5 10M16.83 6L19 10M5 10H19M5 10L3 22H21L19 10"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
